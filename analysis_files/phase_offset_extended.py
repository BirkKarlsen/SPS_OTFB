...
profile_ns, bin_ns = at.import_and_normalize_profile('../data_files/profile_comparison/profile_4000_normal_sign.npy')
...
dt = (np.mean(pos_rs_rp[:72]) - np.mean(mea_pos[:72]))
mea_b = mea_b + dt
